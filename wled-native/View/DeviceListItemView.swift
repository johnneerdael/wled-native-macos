...
struct DeviceListItemView: View {
                    ...
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        HStack {
                            Text(device.address ?? "")
                                ...
                                .lineSpacing(0)
                            Image(nsImage: getSignalImage(isOnline: device.isOnline, signalStrength: Int(device.networkRssi)))
                                .resizable()
    ...
    func getSignalImage(isOnline: Bool, signalStrength: Int) -> NSImage {
    ...
    func colorFromHex(rgbValue: Int, alpha: Double? = 1.0) -> Color {
        ...
        // Divide by 0xFF because Color takes CGFloats between 0.0 and 1.0
        ...
        return fixColor(color: Color(.sRGB, red: red, green: green, blue: blue, opacity: alpha))
    }
